          ...
          <div className="container">
                <div className="b-editor" >
                    <div className="b-gray">
                        <div className="b-want-guarantee">
                            <div className="want-guarantee__inner">
                                ...
                                <div className="want-guarantee__text">Нашим главным преимуществом является направленность на поисковую оптимизацию. Мы работаем на результат. Если вам нужен надежный помощник в бурном и постоянно меняющимся океане digital продвижения по выгодной цене, то вы нашли его. С нами вы всегда на гребне новых течений.
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div className="places-imgs__item">
                                        <div className="places-imgs__img-wrapper"><Link
                                                href="#" className="disabled"  rel="nofollow"><img
                                                    ...
                                                    src="/files/1/sert2.png" /> </Link></div>
                                        <div className="places-imgs__text">
                                            <p className="places-imgs__heading">Золотой партнер</p>
                                            <p className="places-imgs__bottom-text">1С Bitrix <br />
                    ...
                    <div className="b-types-of-site">
                        <div className="types-of-site__item">
                            <div className="types-of-site__img"><Link
                                    href="#" className="disabled"  rel="nofollow"><img
                                        src="/files/110/type-2.png" /></Link></div>
                            <div className="types-of-site__title"><Link href="#" className="disabled"  rel="nofollow">Разработка сайтов</Link></div>
                            <div className="types-of-site__price">от&nbsp;<span>12&nbsp;000&nbsp;₽</span></div>
                        </div>
                        <div className="types-of-site__item">
                            <div className="types-of-site__img"><Link
                                    href="#" className="disabled"  rel="nofollow"><img
                                        src="/files/110/type-1.png" /></Link></div>
                            <div className="types-of-site__title"><Link href="#" className="disabled"  rel="nofollow">Доработка
                                    сайтов</Link></div>
                        ...
                        <div className="types-of-site__item">
                            <div className="types-of-site__img"><Link
                                    href="#" className="disabled"  rel="nofollow"><img
                                        src="/files/110/type-3.png" /></Link></div>
                            <div className="types-of-site__title"><Link
                                    href="#" className="disabled"  rel="nofollow">Digital-стратегия</Link>
                            </div>
                            <div className="types-of-site__price">от&nbsp;<span>15&nbsp;000&nbsp;₽</span></div>
                        </div>
                        <div className="types-of-site__item">
                            <div className="types-of-site__img"><Link href="#" className="disabled"  rel="nofollow"><img
                                        src="/files/110/type-4.png" /></Link></div>
                            <div className="types-of-site__title"><Link href="#" className="disabled"  rel="nofollow">SEO-продвижение</Link>
                            </div>
                            <div className="types-of-site__price">от&nbsp;<span>19 000&nbsp;₽</span></div>
                        </div>
                        <div className="types-of-site__item">
                            <div className="types-of-site__img"><Link href="#" className="disabled"  rel="nofollow"><img
                                        src="/files/110/type-5.png" /></Link></div>
                            <div className="types-of-site__title"><Link href="#" className="disabled"  rel="nofollow">Реклама</Link></div>
                            <div className="types-of-site__price">от&nbsp;<span>15&nbsp;000&nbsp;₽</span></div>
                        </div>
                    </div>
            ...
            <div className="container">
                <div className="b-portfolio-carousel">
                    ...
                    {/* <div className="portfolio-carousel__carousel">
                        <div className="js-carousel-portfolio">
                            <div className="portfolio-carousel__item"> Разработка корпоративного сайта для института
                                «МИРБИС» <img className="owl-lazy" alt=""
                                    data-src="/files/1/por1.jpg" /> <Link
                                    className="portfolio-carousel__link" rel="nofollow"
                                    href="/portfolio/razrabotka-korporativnogo-sajta-dlya-instituta-mirbis/"></Link> </div>
                            <div className="portfolio-carousel__item"> Разработка лендинга бренда водки «Drink House» <img
                                    className="owl-lazy" alt=""
                                    data-src="/files/1/por1.jpg" /> <Link
                                    className="portfolio-carousel__link" rel="nofollow"
                                    href="/portfolio/razrabotka-lendinga-brenda-vodki-drink-house/"></Link> </div>
                            <div className="portfolio-carousel__item"> Сайт для компании becker mining <img className="owl-lazy"
                                    alt="" data-src="/files/1/por1.jpg" /> <Link
                                    className="portfolio-carousel__link" rel="nofollow"
                                    href="/portfolio/sajt-dlya-kompanii-becker-mining/"></Link> </div>
                            <div className="portfolio-carousel__item"> Корпоративный сайт для компании Браво Софт <img
                                    className="owl-lazy" alt="" rel="nofollow"
                                    data-src="/files/1/por1.jpg" /> <Link
                                    className="portfolio-carousel__link"
                                    href="/portfolio/korporativnyj-sajt-dlya-kompanii-bravo-soft/"></Link> </div>
                            <div className="portfolio-carousel__item"> Сайт для оконной компании «Аконика» <img
                                    className="owl-lazy" alt="" rel="nofollow"
                                    data-src="/files/1/por1.jpg" /> <Link
                                    className="portfolio-carousel__link" rel="nofollow"
                                    href="/portfolio/sajt-dlya-okonnoj-kompanii-akonika/"></Link> </div>
                            <div className="portfolio-carousel__item"> Редизайн сайта мебельного интернет-магазина <img
                                    className="owl-lazy" alt="" data-src="/files/1/por1.jpg" /> <Link
                                    className="portfolio-carousel__link" rel="nofollow"
                                    href="/portfolio/redizajn-sajta-mebelnogo-internet-magazina/"></Link> </div>
                            <div className="portfolio-carousel__item"> Модернизация сайта по внедрению решений комплексного
                                мониторинга на предприятиях <img className="owl-lazy" alt=""
                                    data-src="/files/1/por1.jpg" /> <Link className="portfolio-carousel__link" rel="nofollow"
                                    href="/portfolio/modernizaciya-sajta-po-vnedreniyu-reshenij-kompleksnogo-monitoringa-na-predpriyatiyah/"></Link>
                            </div>
                            <div className="portfolio-carousel__item"> Создание сайта для ремонтной компании из Москвы <img
                                    className="owl-lazy" alt="" data-src="/files/1/por1.jpg" /> <Link
                                    className="portfolio-carousel__link" rel="nofollow"
                                    href="/portfolio/sozdanie-sajta-dlya-remontnoj-kompanii-iz-moskvy/"></Link> </div>
                            <div className="portfolio-carousel__item"> Разработка сайта для системы мониторинга <img
                                    className="owl-lazy" alt="" data-src="/files/1/por1.jpg" /> <Link
                                    className="portfolio-carousel__link" rel="nofollow"
                                    href="/portfolio/razrabotka-sajta-dlya-sistemy-monitoringa/"></Link> </div>
                            <div className="portfolio-carousel__item"> Сайт для летной школы с каталогом курсов <img
                                    className="owl-lazy" alt="" data-src="/files/1/por1.jpg" /> <Link
                                    className="portfolio-carousel__link" rel="nofollow"
                                    href="/portfolio/sajt-dlya-letnoj-shkoly-s-katalogom-kursov/"></Link> </div>
                            <div className="portfolio-carousel__item"> Разработка интернет-магазина эксклюзивных сувениров
                                <img className="owl-lazy" alt="" data-src="/files/1/por1.jpg" /> <Link
                                    className="portfolio-carousel__link"
                                    href="/portfolio/razrabotka-internet-magazina-eksklyuzivnyh-suvenirov/"></Link> </div>
                        </div>
                    </div> */}
                </div>
            </div>
                            ...
                            <div className="col-4-12 tablet-col-6-12">
                                <div className="guestbox__item">
                                    <div className="guestbox__head">
                                        <div className="guestbox__icon"><img src="/files/110/guestbox-icon.png" alt=""/>
                                        </div>
